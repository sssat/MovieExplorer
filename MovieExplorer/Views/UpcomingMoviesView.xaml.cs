...
public partial class UpcomingMoviesView : UserControl
{
    ...
    private async Task LoadMoviesAsync()
    {
        ...
        try
        {
            ...
            IReadOnlyList<KobisUpcomingMovie> upcomingMovies = await kobisClient.GetUpcomingMoviesAsync(
                DateTime.Today,
    ...
    private static async Task<List<Movie>> EnrichWithTmdbAsync(
        IReadOnlyList<KobisUpcomingMovie> kobisMovies)
    {
    ...
    private static Movie Merge(KobisUpcomingMovie kobis, Movie? tmdb)
    {
